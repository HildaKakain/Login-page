...
const Login2 = () => {
  return (
    <div className='relative w-full h-screen bg-zinc-900/90'>
        <img className='absolute w-full h-full object-cover mix-blend-overlay' src={miniature} alt="/" />

        <div className='flex justify-center items-center h-full'>
            <form className='max-w-[400px] w-full mx-auto bg-white p-8'>
                <h2 className='text-4xl font-bold text-center py-4'>H.D.K</h2>
                ...
                <p className='flex items-center mt-2'><input className='mr-2' type="checkbox"></input>Remember Me</p>
